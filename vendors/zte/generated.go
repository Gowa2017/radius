...
func NATIPAddress_Add(p *radius.Packet, value net.IP) (err error) {
	var a radius.Attribute
	a, err = radius.NewIPAddr(value)
	if err != nil {
		return
	}
	return _ZTE_AddVendor(p, 98, a)
}

func NATIPAddress_Get(p *radius.Packet) (value net.IP) {
	value, _ = NATIPAddress_Lookup(p)
	return
}

func NATIPAddress_Gets(p *radius.Packet) (values []net.IP, err error) {
	var i net.IP
	for _, attr := range _ZTE_GetsVendor(p, 98) {
...
func NATIPAddress_Lookup(p *radius.Packet) (value net.IP, err error) {
	a, ok := _ZTE_LookupVendor(p, 98)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
...
func NATIPAddress_Set(p *radius.Packet, value net.IP) (err error) {
	var a radius.Attribute
	a, err = radius.NewIPAddr(value)
	if err != nil {
		return
	}
	return _ZTE_SetVendor(p, 98, a)
}

func NATIPAddress_Del(p *radius.Packet) {
	_ZTE_DelVendor(p, 98)
}

type NATStartPort uint32

var NATStartPort_Strings = map[NATStartPort]string{}

func (a NATStartPort) String() string {
	if str, ok := NATStartPort_Strings[a]; ok {
		return str
	}
	return "NATStartPort(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func NATStartPort_Add(p *radius.Packet, value NATStartPort) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_AddVendor(p, 99, a)
}

func NATStartPort_Get(p *radius.Packet) (value NATStartPort) {
	value, _ = NATStartPort_Lookup(p)
	return
}

func NATStartPort_Gets(p *radius.Packet) (values []NATStartPort, err error) {
	var i uint32
	for _, attr := range _ZTE_GetsVendor(p, 99) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, NATStartPort(i))
	}
	return
}

func NATStartPort_Lookup(p *radius.Packet) (value NATStartPort, err error) {
	a, ok := _ZTE_LookupVendor(p, 99)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = NATStartPort(i)
	return
}

func NATStartPort_Set(p *radius.Packet, value NATStartPort) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_SetVendor(p, 99, a)
}
...
type NATEndPort uint32

var NATEndPort_Strings = map[NATEndPort]string{}

func (a NATEndPort) String() string {
	if str, ok := NATEndPort_Strings[a]; ok {
		return str
	}
	return "NATEndPort(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func NATEndPort_Add(p *radius.Packet, value NATEndPort) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_AddVendor(p, 100, a)
}

func NATEndPort_Get(p *radius.Packet) (value NATEndPort) {
	value, _ = NATEndPort_Lookup(p)
	return
}

func NATEndPort_Gets(p *radius.Packet) (values []NATEndPort, err error) {
	var i uint32
	for _, attr := range _ZTE_GetsVendor(p, 100) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, NATEndPort(i))
	}
	return
}

func NATEndPort_Lookup(p *radius.Packet) (value NATEndPort, err error) {
	a, ok := _ZTE_LookupVendor(p, 100)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
...
func NATEndPort_Set(p *radius.Packet, value NATEndPort) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_SetVendor(p, 100, a)
}

func NATEndPort_Del(p *radius.Packet) {
	_ZTE_DelVendor(p, 100)
}
...
type QOSSubcarCirUpUser uint32

var QOSSubcarCirUpUser_Strings = map[QOSSubcarCirUpUser]string{}

func (a QOSSubcarCirUpUser) String() string {
	if str, ok := QOSSubcarCirUpUser_Strings[a]; ok {
		return str
	}
	return "QOSSubcarCirUpUser(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func QOSSubcarCirUpUser_Add(p *radius.Packet, value QOSSubcarCirUpUser) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_AddVendor(p, 127, a)
}

func QOSSubcarCirUpUser_Get(p *radius.Packet) (value QOSSubcarCirUpUser) {
	value, _ = QOSSubcarCirUpUser_Lookup(p)
	return
}

func QOSSubcarCirUpUser_Gets(p *radius.Packet) (values []QOSSubcarCirUpUser, err error) {
	var i uint32
	for _, attr := range _ZTE_GetsVendor(p, 127) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, QOSSubcarCirUpUser(i))
	}
	return
}

func QOSSubcarCirUpUser_Lookup(p *radius.Packet) (value QOSSubcarCirUpUser, err error) {
	a, ok := _ZTE_LookupVendor(p, 127)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = QOSSubcarCirUpUser(i)
	return
}

func QOSSubcarCirUpUser_Set(p *radius.Packet, value QOSSubcarCirUpUser) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_SetVendor(p, 127, a)
}

func QOSSubcarCirUpUser_Del(p *radius.Packet) {
	_ZTE_DelVendor(p, 127)
}

type QOSSubcarPirUpUser uint32

var QOSSubcarPirUpUser_Strings = map[QOSSubcarPirUpUser]string{}

func (a QOSSubcarPirUpUser) String() string {
	if str, ok := QOSSubcarPirUpUser_Strings[a]; ok {
		return str
	}
	return "QOSSubcarPirUpUser(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func QOSSubcarPirUpUser_Add(p *radius.Packet, value QOSSubcarPirUpUser) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_AddVendor(p, 128, a)
}

func QOSSubcarPirUpUser_Get(p *radius.Packet) (value QOSSubcarPirUpUser) {
	value, _ = QOSSubcarPirUpUser_Lookup(p)
	return
}

func QOSSubcarPirUpUser_Gets(p *radius.Packet) (values []QOSSubcarPirUpUser, err error) {
	var i uint32
	for _, attr := range _ZTE_GetsVendor(p, 128) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, QOSSubcarPirUpUser(i))
	}
	return
}

func QOSSubcarPirUpUser_Lookup(p *radius.Packet) (value QOSSubcarPirUpUser, err error) {
	a, ok := _ZTE_LookupVendor(p, 128)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = QOSSubcarPirUpUser(i)
	return
}

func QOSSubcarPirUpUser_Set(p *radius.Packet, value QOSSubcarPirUpUser) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_SetVendor(p, 128, a)
}

func QOSSubcarPirUpUser_Del(p *radius.Packet) {
	_ZTE_DelVendor(p, 128)
}

type QOSSubcarCirDownUser uint32

var QOSSubcarCirDownUser_Strings = map[QOSSubcarCirDownUser]string{}

func (a QOSSubcarCirDownUser) String() string {
	if str, ok := QOSSubcarCirDownUser_Strings[a]; ok {
		return str
	}
	return "QOSSubcarCirDownUser(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func QOSSubcarCirDownUser_Add(p *radius.Packet, value QOSSubcarCirDownUser) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_AddVendor(p, 131, a)
}

func QOSSubcarCirDownUser_Get(p *radius.Packet) (value QOSSubcarCirDownUser) {
	value, _ = QOSSubcarCirDownUser_Lookup(p)
	return
}

func QOSSubcarCirDownUser_Gets(p *radius.Packet) (values []QOSSubcarCirDownUser, err error) {
	var i uint32
	for _, attr := range _ZTE_GetsVendor(p, 131) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, QOSSubcarCirDownUser(i))
	}
	return
}

func QOSSubcarCirDownUser_Lookup(p *radius.Packet) (value QOSSubcarCirDownUser, err error) {
	a, ok := _ZTE_LookupVendor(p, 131)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = QOSSubcarCirDownUser(i)
	return
}

func QOSSubcarCirDownUser_Set(p *radius.Packet, value QOSSubcarCirDownUser) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_SetVendor(p, 131, a)
}

func QOSSubcarCirDownUser_Del(p *radius.Packet) {
	_ZTE_DelVendor(p, 131)
}

type QOSSubcarPirDownUser uint32

var QOSSubcarPirDownUser_Strings = map[QOSSubcarPirDownUser]string{}

func (a QOSSubcarPirDownUser) String() string {
	if str, ok := QOSSubcarPirDownUser_Strings[a]; ok {
		return str
	}
	return "QOSSubcarPirDownUser(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func QOSSubcarPirDownUser_Add(p *radius.Packet, value QOSSubcarPirDownUser) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_AddVendor(p, 132, a)
}

func QOSSubcarPirDownUser_Get(p *radius.Packet) (value QOSSubcarPirDownUser) {
	value, _ = QOSSubcarPirDownUser_Lookup(p)
	return
}

func QOSSubcarPirDownUser_Gets(p *radius.Packet) (values []QOSSubcarPirDownUser, err error) {
	var i uint32
	for _, attr := range _ZTE_GetsVendor(p, 132) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, QOSSubcarPirDownUser(i))
	}
	return
}

func QOSSubcarPirDownUser_Lookup(p *radius.Packet) (value QOSSubcarPirDownUser, err error) {
	a, ok := _ZTE_LookupVendor(p, 132)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = QOSSubcarPirDownUser(i)
	return
}

func QOSSubcarPirDownUser_Set(p *radius.Packet, value QOSSubcarPirDownUser) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_SetVendor(p, 132, a)
}

func QOSSubcarPirDownUser_Del(p *radius.Packet) {
	_ZTE_DelVendor(p, 132)
}
...
type V6InputOctets uint32

var V6InputOctets_Strings = map[V6InputOctets]string{}

func (a V6InputOctets) String() string {
	if str, ok := V6InputOctets_Strings[a]; ok {
		return str
	}
	return "V6InputOctets(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func V6InputOctets_Add(p *radius.Packet, value V6InputOctets) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_AddVendor(p, 245, a)
}

func V6InputOctets_Get(p *radius.Packet) (value V6InputOctets) {
	value, _ = V6InputOctets_Lookup(p)
	return
}

func V6InputOctets_Gets(p *radius.Packet) (values []V6InputOctets, err error) {
	var i uint32
	for _, attr := range _ZTE_GetsVendor(p, 245) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, V6InputOctets(i))
	}
	return
}

func V6InputOctets_Lookup(p *radius.Packet) (value V6InputOctets, err error) {
	a, ok := _ZTE_LookupVendor(p, 245)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = V6InputOctets(i)
	return
}

func V6InputOctets_Set(p *radius.Packet, value V6InputOctets) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_SetVendor(p, 245, a)
}

func V6InputOctets_Del(p *radius.Packet) {
	_ZTE_DelVendor(p, 245)
}

type V6InputGigaOctets uint32

var V6InputGigaOctets_Strings = map[V6InputGigaOctets]string{}

func (a V6InputGigaOctets) String() string {
	if str, ok := V6InputGigaOctets_Strings[a]; ok {
		return str
	}
	return "V6InputGigaOctets(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func V6InputGigaOctets_Add(p *radius.Packet, value V6InputGigaOctets) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_AddVendor(p, 246, a)
}

func V6InputGigaOctets_Get(p *radius.Packet) (value V6InputGigaOctets) {
	value, _ = V6InputGigaOctets_Lookup(p)
	return
}

func V6InputGigaOctets_Gets(p *radius.Packet) (values []V6InputGigaOctets, err error) {
	var i uint32
	for _, attr := range _ZTE_GetsVendor(p, 246) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, V6InputGigaOctets(i))
	}
	return
}

func V6InputGigaOctets_Lookup(p *radius.Packet) (value V6InputGigaOctets, err error) {
	a, ok := _ZTE_LookupVendor(p, 246)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = V6InputGigaOctets(i)
	return
}

func V6InputGigaOctets_Set(p *radius.Packet, value V6InputGigaOctets) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_SetVendor(p, 246, a)
}

func V6InputGigaOctets_Del(p *radius.Packet) {
	_ZTE_DelVendor(p, 246)
}

type V6OutputOctets uint32

var V6OutputOctets_Strings = map[V6OutputOctets]string{}

func (a V6OutputOctets) String() string {
	if str, ok := V6OutputOctets_Strings[a]; ok {
		return str
	}
	return "V6OutputOctets(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func V6OutputOctets_Add(p *radius.Packet, value V6OutputOctets) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_AddVendor(p, 247, a)
}

func V6OutputOctets_Get(p *radius.Packet) (value V6OutputOctets) {
	value, _ = V6OutputOctets_Lookup(p)
	return
}

func V6OutputOctets_Gets(p *radius.Packet) (values []V6OutputOctets, err error) {
	var i uint32
	for _, attr := range _ZTE_GetsVendor(p, 247) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, V6OutputOctets(i))
	}
	return
}

func V6OutputOctets_Lookup(p *radius.Packet) (value V6OutputOctets, err error) {
	a, ok := _ZTE_LookupVendor(p, 247)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = V6OutputOctets(i)
	return
}

func V6OutputOctets_Set(p *radius.Packet, value V6OutputOctets) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_SetVendor(p, 247, a)
}

func V6OutputOctets_Del(p *radius.Packet) {
	_ZTE_DelVendor(p, 247)
}

type V6OututGigaOctets uint32

var V6OututGigaOctets_Strings = map[V6OututGigaOctets]string{}

func (a V6OututGigaOctets) String() string {
	if str, ok := V6OututGigaOctets_Strings[a]; ok {
		return str
	}
	return "V6OututGigaOctets(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func V6OututGigaOctets_Add(p *radius.Packet, value V6OututGigaOctets) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_AddVendor(p, 248, a)
}

func V6OututGigaOctets_Get(p *radius.Packet) (value V6OututGigaOctets) {
	value, _ = V6OututGigaOctets_Lookup(p)
	return
}

func V6OututGigaOctets_Gets(p *radius.Packet) (values []V6OututGigaOctets, err error) {
	var i uint32
	for _, attr := range _ZTE_GetsVendor(p, 248) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, V6OututGigaOctets(i))
	}
	return
}

func V6OututGigaOctets_Lookup(p *radius.Packet) (value V6OututGigaOctets, err error) {
	a, ok := _ZTE_LookupVendor(p, 248)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = V6OututGigaOctets(i)
	return
}

func V6OututGigaOctets_Set(p *radius.Packet, value V6OututGigaOctets) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_SetVendor(p, 248, a)
}

func V6OututGigaOctets_Del(p *radius.Packet) {
	_ZTE_DelVendor(p, 248)
}

type V6InputPackets uint32

var V6InputPackets_Strings = map[V6InputPackets]string{}

func (a V6InputPackets) String() string {
	if str, ok := V6InputPackets_Strings[a]; ok {
		return str
	}
	return "V6InputPackets(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func V6InputPackets_Add(p *radius.Packet, value V6InputPackets) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_AddVendor(p, 249, a)
}

func V6InputPackets_Get(p *radius.Packet) (value V6InputPackets) {
	value, _ = V6InputPackets_Lookup(p)
	return
}

func V6InputPackets_Gets(p *radius.Packet) (values []V6InputPackets, err error) {
	var i uint32
	for _, attr := range _ZTE_GetsVendor(p, 249) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, V6InputPackets(i))
	}
	return
}

func V6InputPackets_Lookup(p *radius.Packet) (value V6InputPackets, err error) {
	a, ok := _ZTE_LookupVendor(p, 249)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = V6InputPackets(i)
	return
}

func V6InputPackets_Set(p *radius.Packet, value V6InputPackets) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_SetVendor(p, 249, a)
}

func V6InputPackets_Del(p *radius.Packet) {
	_ZTE_DelVendor(p, 249)
}

type V6OutputPackets uint32

var V6OutputPackets_Strings = map[V6OutputPackets]string{}

func (a V6OutputPackets) String() string {
	if str, ok := V6OutputPackets_Strings[a]; ok {
		return str
	}
	return "V6OutputPackets(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func V6OutputPackets_Add(p *radius.Packet, value V6OutputPackets) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_AddVendor(p, 250, a)
}

func V6OutputPackets_Get(p *radius.Packet) (value V6OutputPackets) {
	value, _ = V6OutputPackets_Lookup(p)
	return
}

func V6OutputPackets_Gets(p *radius.Packet) (values []V6OutputPackets, err error) {
	var i uint32
	for _, attr := range _ZTE_GetsVendor(p, 250) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, V6OutputPackets(i))
	}
	return
}

func V6OutputPackets_Lookup(p *radius.Packet) (value V6OutputPackets, err error) {
	a, ok := _ZTE_LookupVendor(p, 250)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = V6OutputPackets(i)
	return
}

func V6OutputPackets_Set(p *radius.Packet, value V6OutputPackets) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_SetVendor(p, 250, a)
}

func V6OutputPackets_Del(p *radius.Packet) {
	_ZTE_DelVendor(p, 250)
}

type AcctAddressChange uint32

var AcctAddressChange_Strings = map[AcctAddressChange]string{}

func (a AcctAddressChange) String() string {
	if str, ok := AcctAddressChange_Strings[a]; ok {
		return str
	}
	return "AcctAddressChange(" + strconv.FormatUint(uint64(a), 10) + ")"
}

func AcctAddressChange_Add(p *radius.Packet, value AcctAddressChange) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_AddVendor(p, 251, a)
}

func AcctAddressChange_Get(p *radius.Packet) (value AcctAddressChange) {
	value, _ = AcctAddressChange_Lookup(p)
	return
}

func AcctAddressChange_Gets(p *radius.Packet) (values []AcctAddressChange, err error) {
	var i uint32
	for _, attr := range _ZTE_GetsVendor(p, 251) {
		i, err = radius.Integer(attr)
		if err != nil {
			return
		}
		values = append(values, AcctAddressChange(i))
	}
	return
}

func AcctAddressChange_Lookup(p *radius.Packet) (value AcctAddressChange, err error) {
	a, ok := _ZTE_LookupVendor(p, 251)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
	...
	value = AcctAddressChange(i)
	return
}

func AcctAddressChange_Set(p *radius.Packet, value AcctAddressChange) (err error) {
	a := radius.NewInteger(uint32(value))
	return _ZTE_SetVendor(p, 251, a)
}

func AcctAddressChange_Del(p *radius.Packet) {
	_ZTE_DelVendor(p, 251)
}
