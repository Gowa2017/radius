...
func init() {
	radius.AddType(UserName_Type, "UserName")
	radius.AddType(UserPassword_Type, "UserPassword")
	radius.AddType(CHAPPassword_Type, "CHAPPassword")
	radius.AddType(NASIPAddress_Type, "NASIPAddress")
	radius.AddType(NASPort_Type, "NASPort")
	radius.AddType(ServiceType_Type, "ServiceType")
	radius.AddType(FramedProtocol_Type, "FramedProtocol")
	radius.AddType(FramedIPAddress_Type, "FramedIPAddress")
	radius.AddType(FramedIPNetmask_Type, "FramedIPNetmask")
	radius.AddType(FramedRouting_Type, "FramedRouting")
	radius.AddType(FilterID_Type, "FilterID")
	radius.AddType(FramedMTU_Type, "FramedMTU")
	radius.AddType(FramedCompression_Type, "FramedCompression")
	radius.AddType(LoginIPHost_Type, "LoginIPHost")
	radius.AddType(LoginService_Type, "LoginService")
	radius.AddType(LoginTCPPort_Type, "LoginTCPPort")
	radius.AddType(ReplyMessage_Type, "ReplyMessage")
	radius.AddType(CallbackNumber_Type, "CallbackNumber")
	radius.AddType(CallbackID_Type, "CallbackID")
	radius.AddType(FramedRoute_Type, "FramedRoute")
	radius.AddType(FramedIPXNetwork_Type, "FramedIPXNetwork")
	radius.AddType(State_Type, "State")
	radius.AddType(Class_Type, "Class")
	radius.AddType(VendorSpecific_Type, "VendorSpecific")
	radius.AddType(SessionTimeout_Type, "SessionTimeout")
	radius.AddType(IdleTimeout_Type, "IdleTimeout")
	radius.AddType(TerminationAction_Type, "TerminationAction")
	radius.AddType(CalledStationID_Type, "CalledStationID")
	radius.AddType(CallingStationID_Type, "CallingStationID")
	radius.AddType(NASIdentifier_Type, "NASIdentifier")
	radius.AddType(ProxyState_Type, "ProxyState")
	radius.AddType(LoginLATService_Type, "LoginLATService")
	radius.AddType(LoginLATNode_Type, "LoginLATNode")
	radius.AddType(LoginLATGroup_Type, "LoginLATGroup")
	radius.AddType(FramedAppleTalkLink_Type, "FramedAppleTalkLink")
	radius.AddType(FramedAppleTalkNetwork_Type, "FramedAppleTalkNetwork")
	radius.AddType(FramedAppleTalkZone_Type, "FramedAppleTalkZone")
	radius.AddType(CHAPChallenge_Type, "CHAPChallenge")
	radius.AddType(NASPortType_Type, "NASPortType")
	radius.AddType(PortLimit_Type, "PortLimit")
	radius.AddType(LoginLATPort_Type, "LoginLATPort")
}
